...
public class UrlUtil {
     ...
     *
     * @param str
     * @return 返回处理后的字符串、将所有识别出的链接存入urls中
     */
    public static String handleURLinString(String str, List<String> urls) {
        if (urls == null) {
            urls = new ArrayList<>();
        }
        urls.clear();
     ...
     * 根据url获取 host name
     *
     * @param url https://www.cnblogs.com/Jason-Jan/p/7911013.html
